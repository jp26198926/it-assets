...
interface UserExportButtonsProps<TData> {
  table: Table<TData>;
}

export function UserExportButtons<TData>({ table }: UserExportButtonsProps<TData>) {
    ...
    try {
      ...
      const rows = table
        ...
        .rows.map((row) => {
          ...
          return [
            String(original.first_name || ""),
            String(original.last_name || ""),
            String(original.email || ""),
            String(original.role_name || "N/A"),
