...
import { ItemDataTableToolbar } from "./item-data-table-toolbar";
import { DataTablePagination } from "./data-table-pagination";
import type { Item, ItemAdvancedFilter, ItemFilters } from "@/lib/types/item";
...
export function ItemDataTable<TData, TValue>({
  ...
  const [advancedFilters, setAdvancedFilters] = useState<ItemAdvancedFilter[]>([]);
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        <span className="text-xs text-[#64748b]">{item.brand || "No brand"}</span>
                      </div>
                    </div>
                  </div>
