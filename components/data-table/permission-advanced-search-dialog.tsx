...
interface PermissionAdvancedSearchDialogProps {
  onSearch: (filters: PermissionFilters) => void;
  onClear: () => void;
}

export function PermissionAdvancedSearchDialog({
  onSearch,
  onClear,
}: PermissionAdvancedSearchDialogProps) {
