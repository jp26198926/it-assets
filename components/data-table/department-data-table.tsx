...
import { DepartmentDataTableToolbar } from "./department-data-table-toolbar";
import { DataTablePagination } from "./data-table-pagination";
import type { Department, DepartmentAdvancedFilter, DepartmentFilters } from "@/lib/types/department";
...
export function DepartmentDataTable<TData, TValue>({
  ...
  const [advancedFilters, setAdvancedFilters] = useState<DepartmentAdvancedFilter[]>([]);
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-[#1a1f36]">{department.code} - {department.name}</p>
                      <p className="text-xs text-[#64748b]">{department.description || "No description"}</p>
                    </div>
                  </div>
