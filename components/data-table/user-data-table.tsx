...
import type { User, UserAdvancedFilter, UserFilters } from "@/lib/types/user";
...
export function UserDataTable<TData, TValue>({
  ...
  const [advancedFilters, setAdvancedFilters] = useState<UserAdvancedFilter[]>([]);
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-[#1a1f36]">{user.first_name} {user.last_name}</p>
