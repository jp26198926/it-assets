...
import { PageDataTableToolbar } from "./page-data-table-toolbar";
import { DataTablePagination } from "./data-table-pagination";
import type { Page, PageAdvancedFilter, PageFilters } from "@/lib/types/page";

interface PageDataTableProps<TData, TValue> {
...
export function PageDataTable<TData, TValue>({
  ...
  onServerSearch,
  onServerSearchClear,
}: PageDataTableProps<TData, TValue>) {
  ...
  const [advancedFilters, setAdvancedFilters] = useState<PageAdvancedFilter[]>([]);
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-[#1a1f36]">{page.name}</p>
                      <p className="text-xs text-[#64748b] font-mono">{page.path}</p>
                    </div>
                  </div>
