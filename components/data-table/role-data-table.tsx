...
import { RoleDataTableToolbar } from "./role-data-table-toolbar";
import { DataTablePagination } from "./data-table-pagination";
import type { Role, RoleAdvancedFilter, RoleFilters } from "@/lib/types/role";
...
export function RoleDataTable<TData, TValue>({
  ...
  const [advancedFilters, setAdvancedFilters] = useState<RoleAdvancedFilter[]>([]);
