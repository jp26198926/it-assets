...
import { EmployeeDataTableToolbar } from "./employee-data-table-toolbar";
import { DataTablePagination } from "./data-table-pagination";
import type { Employee, EmployeeAdvancedFilter, EmployeeFilters } from "@/lib/types/employee";
...
export function EmployeeDataTable<TData, TValue>({
  ...
  const [advancedFilters, setAdvancedFilters] = useState<EmployeeAdvancedFilter[]>([]);
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-[#1a1f36]">{employee.firstname} {employee.lastname}</p>
                      <p className="text-xs text-[#64748b]">{employee.email || "No email"}</p>
                    </div>
                  </div>
