...
interface PageExportButtonsProps<TData> {
  table: Table<TData>;
}

export function PageExportButtons<TData>({ table }: PageExportButtonsProps<TData>) {
      ...
      const rows = table
        ...
        .rows.map((row) => {
          ...
          return [
            ...
            String(original.section || "N/A"),
            String(original.parent_name || "Root"),
  ...
  const exportToExcel = async () => {
    try {
      ...
      XLSX.writeFile(wb, "page-report.xlsx");
