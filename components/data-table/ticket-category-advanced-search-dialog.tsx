...
interface TicketCategoryAdvancedSearchDialogProps {
  onSearch: (filters: TicketCategoryFilters) => void;
  onClear: () => void;
}

export function TicketCategoryAdvancedSearchDialog({
  onSearch,
  onClear,
}: TicketCategoryAdvancedSearchDialogProps) {
