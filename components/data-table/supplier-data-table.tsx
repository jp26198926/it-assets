...
import { SupplierDataTableToolbar } from "./supplier-data-table-toolbar";
import { DataTablePagination } from "./data-table-pagination";
import type { Supplier, SupplierAdvancedFilter, SupplierFilters } from "@/lib/types/supplier";

interface SupplierDataTableProps<TData, TValue> {
...
export function SupplierDataTable<TData, TValue>({
  ...
  onServerSearch,
  onServerSearchClear,
}: SupplierDataTableProps<TData, TValue>) {
  ...
  const [advancedFilters, setAdvancedFilters] = useState<SupplierAdvancedFilter[]>([]);
                  ...
                  >
                    <div className="flex flex-col items-center justify-center gap-3 text-[#64748b]">
                      <div className="bg-[#f0f4f8] p-4">
                        <Truck className="size-8 text-[#94a3b8]" />
                      </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-[#1a1f36]">{supplier.name}</p>
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className="text-xs text-[#64748b]">{supplier.contact_person || "No contact person"}</span>
                      </div>
                    </div>
                  </div>
