...
interface LocationExportButtonsProps<TData> {
  table: Table<TData>;
}

export function LocationExportButtons<TData>({ table }: LocationExportButtonsProps<TData>) {
  const exportToPDF = async () => {
    try {
      ...
      doc.setFontSize(18);
      doc.text("Location Report", 14, 22);
