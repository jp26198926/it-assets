...
import { UOMDataTableToolbar } from "./uom-data-table-toolbar";
import { DataTablePagination } from "./data-table-pagination";
import type { UOM, UOMAdvancedFilter, UOMFilters } from "@/lib/types/uom";

interface UOMDataTableProps<TData, TValue> {
...
export function UOMDataTable<TData, TValue>({
  columns,
  data,
  onView,
  onEdit,
  ...
  onServerSearch,
  onServerSearchClear,
}: UOMDataTableProps<TData, TValue>) {
  ...
  const [advancedFilters, setAdvancedFilters] = useState<UOMAdvancedFilter[]>([]);
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-[#1a1f36]">{uom.code} - {uom.name}</p>
                      <p className="text-xs text-[#64748b]">UOM</p>
                    </div>
                  </div>
