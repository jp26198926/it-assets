...
import { PermissionDataTableToolbar } from "./permission-data-table-toolbar";
import { DataTablePagination } from "./data-table-pagination";
import type { Permission, PermissionAdvancedFilter, PermissionFilters } from "@/lib/types/permission";
...
export function PermissionDataTable<TData, TValue>({
  ...
  const [advancedFilters, setAdvancedFilters] = useState<PermissionAdvancedFilter[]>([]);
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-[#1a1f36]">{permission.name}</p>
                      <p className="text-xs text-[#64748b]">{permission.description || "No description"}</p>
                    </div>
                  </div>
