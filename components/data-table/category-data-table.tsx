...
import type { Category, CategoryAdvancedFilter, CategoryFilters } from "@/lib/types/category";
...
export function CategoryDataTable<TData, TValue>({
  ...
  const [advancedFilters, setAdvancedFilters] = useState<CategoryAdvancedFilter[]>([]);
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-[#1a1f36]">{category.name}</p>
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className={`inline-flex items-center px-2 py-0.5 text-[10px] font-semibold ${tConfig.color}`}>
                          {category.type}
                        </span>
                        <span className="text-xs text-[#64748b]">{category.description || "No description"}</span>
                      </div>
                    </div>
                  </div>
