...
interface DepartmentExportButtonsProps<TData> {
  table: Table<TData>;
}

export function DepartmentExportButtons<TData>({ table }: DepartmentExportButtonsProps<TData>) {
  const exportToPDF = async () => {
    try {
      ...
      doc.setFontSize(18);
      doc.text("Department Report", 14, 22);
  ...
  const exportToExcel = async () => {
    try {
      ...
      XLSX.writeFile(wb, "department-report.xlsx");
